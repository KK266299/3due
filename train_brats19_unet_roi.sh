python main.py \
  ...
  dataset=brats19 \
  task.run_name=victim_tap_noise_4_255 \
  model=unet \
  model.name=unet \
  task=brats19_seg \
  training.epochs=100 \
  ...
  training.data.poison.source.manifest_path=/home/dengzhipeng/data/project/3d_ue/outputs/brats19_ue/tap_noise_4_255/20260225_074809/noise/epoch_0099/manifest.json
#   task.run_name=clean \
#   model=unet \
#   model.name=unet \
#   task=brats19_seg \
