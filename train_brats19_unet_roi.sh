python main.py \
  ...
  training.data.poison.source.manifest_path=/home/dengzhipeng/data/project/3d_ue/outputs/kits19_ue/unet_roi_noise_4_255/20260105_075932/noise/epoch_0099/manifest.json
#   dataset=brats19 \
#   task.run_name=clean \
#   model=unet \
#   model.name=unet \
