...
Table~\ref{tab:ablation} validates each component: removing $\mathcal{L}_{\text{ISC}}$ causes the largest drop, confirming inter-slice spectral disruption is the primary attack vector; removing $\mathcal{L}_{\text{SPD}}$ also degrades protection.
