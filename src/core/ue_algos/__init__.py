...
__all__ = [
    ...
    "noise_slice_frequence", "noise_slice_coherent","noise_slice_coherent_v1", "noise_slice_coherent_v2", "noise_coherent","noise_slice_frequence_z_up", "noise_slice_frequence_logits", 
]